...
def tuple_op():
    ...
    # Based on the prompt, I would assume t2=t1[-1], however based on the answer
    # file this seems to be correct?
    t2 = t1[1:]

    # Concatenate tuple (5,6) and assign it to a variable t3

    # Based on the prompt, I would assume t3=t1+(5,6), however based on the answer
    # file this seems to be correct?
    t3 = t1[1:] + (5,6)
